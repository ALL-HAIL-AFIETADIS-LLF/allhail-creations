        ...
        >
          ...
          >
            ...
            >
              Token tracker:&nbsp;
                <StyledLink
                  title={"0xc06fd77c1aec4dccefc2fe6b3649ec454585fb15"}
                  target={"_blank"}
                  href={"https://polygonscan.com/token/0xc06fd77c1aec4dccefc2fe6b3649ec454585fb15"}
                  rel={"noreferrer"}
                >
                  {truncate("0xc06fd77c1aec4dccefc2fe6b3649ec454585fb15", 7)}
                </StyledLink>
            </s.TextDescription>
          </s.Container>
          <s.SpacerLarge />
                ...
                >
                  But, you still can expose and spread the viruses on&nbsp;
                    <StyledLink
                      ...
                      rel={"noreferrer"}
                    >
                      OpenSea.IO marketplace to make a pandemic.
                    </StyledLink>
                </s.TextDescription>
              </s.Container>
              <s.SpacerLarge />
